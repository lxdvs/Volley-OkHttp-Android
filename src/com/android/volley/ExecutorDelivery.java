...
public class ExecutorDelivery implements ResponseDelivery {
    ...
    public void postError(Request<?> request, VolleyError error) {
        ...
        if (request.getReturnStrategy() == ReturnStrategy.ONCE_LATE && request.mCacheResponse != null) {
    ...
    private class ResponseDeliveryRunnable implements Runnable {
        ...
        public void run() {
            ...
            } else if (mRequest.getReturnStrategy() == ReturnStrategy.ONCE_LATE && mRequest.mCacheResponse != null) {
